"""
Ideal spontaneous parametric downconversion source implementation
"""
import numpy as np
...
class Spdc(GenericDevice):
    ...
    def des(self, time, *args, **kwargs):
        if "photon_num" in kwargs["signals"]:
            ...
            env = Envelope()
            # Applying operation
            op = Operation(FockOperationType.Creation, apply_count=n)
